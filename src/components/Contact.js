            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://github.com/uosry2" className="h-10 w-10 rounded-full bg-[#333]/10 flex items-center justify-center text-[#333] dark:text-white hover:bg-[#333] hover:text-white transition-colors duration-300">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
